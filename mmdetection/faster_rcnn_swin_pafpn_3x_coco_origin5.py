...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/opt/ml/detection/dataset/cv2_train_5.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/opt/ml/detection/dataset/cv2_val_5.json',
        img_prefix='/opt/ml/detection/dataset/',
        classes=[
            'General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
            'Plastic', 'Styrofoam', 'Plastic bag', 'Battery', 'Clothing'
...
work_dir = '/opt/ml/detection/baseline/mmdetection/work_dirs/faster_rcnn/upup5'
auto_resume = False
gpu_ids = [0]
