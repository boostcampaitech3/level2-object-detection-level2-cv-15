...
train_pipeline = [
    ...
    dict(
        ...
        policies=[[{
            'type': 'Resize',
            'img_scale': [(512, 1024), (100, 1024)],
            'multiscale_mode': 'range',
            'keep_ratio': True
        }],
                  [{
                      'type': 'Resize',
                      'img_scale': [(512, 1024), (800, 1024)],
                      'multiscale_mode': 'range',
                      'keep_ratio': True
                  }, {
                      'type': 'RandomCrop',
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/opt/ml/detection/dataset/train_remove.json',
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='cascade_multi_scale_value'))
    ])
...
work_dir = '/opt/ml/detection/baseline/mmdetection/work_dirs/cascade_rcnn_swin_pafpn_3x_renew'
auto_resume = False
gpu_ids = [0]
