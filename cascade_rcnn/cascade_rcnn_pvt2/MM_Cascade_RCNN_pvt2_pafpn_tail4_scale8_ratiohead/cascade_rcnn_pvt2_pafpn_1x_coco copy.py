    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='MM_Cascade_RCNN_pvt2_pafpn_tail4_scale8_ratiohead'))
    ])
...
work_dir = './work_dirs/carscade_rcnn_pvt2_pafpn_1x_trash/MM_Cascade_RCNN_pvt2_pafpn_tail4_scale8_ratiohead'
auto_resume = False
gpu_ids = [0]
