model = dict(
    ...
    roi_head=dict(
        type='CascadeRoIHead',
        num_stages=5,
        stage_loss_weights=[2, 1, 0.5, 0.25, 0.125],
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='MM_Cascade_RCNN_pvt2_pafpn_head5'))
    ])
...
work_dir = './work_dirs/carscade_rcnn_pvt2_pafpn_1x_trash/MM_Cascade_RCNN_pvt2_pafpn_head5'
auto_resume = False
gpu_ids = [0]
