...
def parse_args():
    ...
    parser.add_argument('--config', default = '/opt/ml/detection/baseline/mmdetection/boostcamp/cascade_rcnn_pvt2_pafpn_1x_coco_ms.py',
        help='train config file path')
    parser.add_argument('--root', default = '/opt/ml/detection/dataset/')
    parser.add_argument('--name', default = 'MM_Cascade_RCNN_pvt2_pafpn_ms_range')
    parser.add_argument('--name_wandb', default = 'MM_Cascade_RCNN_pvt2_pafpn_ms_range')
    parser.add_argument('--resize', type = int, default = 512)
    parser.add_argument('--work-dir', default = './work_dirs/carscade_rcnn_pvt2_pafpn_1x_trash/',
