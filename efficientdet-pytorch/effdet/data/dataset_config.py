...
@dataclass
class TrashTrainVal(CocoCfg):
    variant: str = None
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='eff_cv2_train_1.json', img_dir='images', has_labels=True),
        val=dict(ann_filename='eff_cv2_val_1.json', img_dir='images', has_labels=True),
        test=dict(ann_filename='eff_test.json', img_dir='images', has_labels=False),
    ))
